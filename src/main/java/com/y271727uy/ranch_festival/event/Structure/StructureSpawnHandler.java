...
public final class StructureSpawnHandler {
    ...
    public static void onLevelLoad(LevelEvent.Load event) {
        ...
        DimensionDefinition definition = DimensionDefinition.findByDimension(serverLevel.dimension());
        if (definition == null) {
            return;
        }
        ...
        if (!StructureTemplatePlacer.tryPlace(serverLevel, definition)) {
            generateStructure(serverLevel, origin);
        }
    ...
    private static void generateStructure(ServerLevel level, BlockPos origin) {
